...
enum states {INIT, display_zero, display_pushes, unlocked, incorrect, locked } state; //TODO: finish the enum for the SM
...
unsigned int adc_val_x = ADC_read(2);  // Read joystick x-axis
  ...
  switch(state) {
    ...
    case display_pushes:
    //serial_println("STATE: display_pushes");
    //serial_println(flash_lights);
    ...
    case incorrect:
    //serial_println("State: incorrect_trans");
    //serial_println(flash_lights);
    ...
    case locked:
    //serial_println("State: locked_trans");
    //serial_println(flash_lights);
  ...
  switch(state) {
    ...
    case display_pushes:
    // _delay_ms(1000);
    //serial_println("Y axis: ");
    //serial_println(adc_val_y);
    //serial_println("X axis: ");
    //serial_println(adc_val_x);

     
    // serial_println(Moves_made);
      //serial_println(correct_entries);
